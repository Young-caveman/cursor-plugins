...
4. **Spawn N parallel candidates** on the profiles configured for `arena runners` in the [PStack routing policy](../../setup-pstack/references/model-routing.md). Each works in its own sanitized dir. Same prompt to each.
