...
- **Session pickup.** Resuming or taking over a prior agent's in-flight work from a T3 thread, harness transcript, or pushed branch. `playbooks/session-pickup.md`.
